...
document.querySelector('button#fonts').addEventListener('click', tnrToArial); // Do not alter lines of code 2-4!

var blueParagraph = document.querySelector("#blueText");
...
;
var greenParagraphs = document.querySelectorAll(".greenBg");
...
function greenToPink() {
  var _iterator = _createForOfIteratorHelper(greenParagraphs),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var greenParagraph = _step.value;
...
var tnrParagraph = document.querySelector("#tnrParagraph");
